...
def compute_circle_path(radius: int, center: tuple):
    """
    Compute a set of finite coordinates to simulate a circle trajectory of
    input radius around a given center
    @param radius: An integer that represents the radius of the trajectory
    @param center: tuple (x, y) the center of the trajectory
