...
class Packet(Entity):
    """
    A packet is an entity created by an event in the Area-of-Interest.
    """

    def __init__(self, simulator, event_ref: "Event" = None):
        """
        ...
        super().__init__(id(self), event_ref.coords, simulator)
    ...
    def is_expired(self):
        ...
        return self.simulator.cur_step > self.event_ref.deadline  # or self.__TTL > self.__max_TTL  # TODO: questionable
...
class DataPacket(Packet):
    ...
    def __init__(self, simulator, event_ref: "Event" = None):
        super().__init__(simulator, event_ref)


class ACKPacket(Packet):
    """
    An ACKPacket is created to reply to a generic packet.
    It is created using the null_event
    """

    def __init__(self, src_drone, dst_drone, simulator, acked_packet, event_ref: "Event"):
        super().__init__(simulator, event_ref)
...
class HelloPacket(Packet):
    ...
    def __init__(self, src_drone, simulator, cur_pos, speed, next_target, event_ref):
        super().__init__(simulator, event_ref=event_ref)
