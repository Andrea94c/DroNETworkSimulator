...
"""
# ----------------------- PATH DRONES -----------------------------------------#
CIRCLE_PATH = False  # bool: whether to use circle paths around the depot
...
EVENTS_DURATION = 2000  # int: steps, number of time steps that an event lasts  -> to seconds = step * step_duration.
...
Example:
given D_FEEL_EVENT = 500, P_FEEL_EVENT = 0.5, every 500 steps with probability 0.5 the drone will feel an event.
