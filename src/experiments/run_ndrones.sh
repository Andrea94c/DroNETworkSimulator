...
wait
python3 -m src.experiments.json_and_plot -nd 2 -nd 5 -nd 10 -nd 15 -nd 20 -nd 30 -nd 40 -i_s 1 -e_s 5 -exp_suffix MGEO -exp_suffix GEO -exp_suffix RND -exp_suffix AI
